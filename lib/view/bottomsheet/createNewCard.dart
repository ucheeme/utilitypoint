              ...
              StreamBuilder<Object>(
                ...
                builder: (context, snapshot) {
                  return DropdownButtonFormField<String>(
                    ...
                    isDense: false,
                    items: widget.bloc.validation.currencies.map((String value) {
                    ...
                    decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                          borderSide:
                              BorderSide(color: AppColor.black100, width: 0.5.w),
                        ...
                        border: OutlineInputBorder(
                          borderSide: const BorderSide(color: AppColor.primary90),
                          borderRadius: BorderRadius.circular(4.r),
                        ),
              ...
              StreamBuilder<Object>(
                ...
                builder: (context, snapshot) {
                  return DropdownButtonFormField<String>(
                    iconEnabledColor: AppColor.black60,
                    isDense: false,
                    items: widget.bloc.validation.cardType.map((String value) {
                      return DropdownMenuItem<String>(
                        value: value,
                        child: Text(
                          value,
                ...
                builder: (context, snapshot) {
                  return CustomButton(
                    onTap: () {
                      ...
                      if(snapshot.hasData){
                        if (double.parse(loginResponse!.dollarWallet) == 0) {
                        ...
                        AppUtils.showInfoSnackFromBottom("All Field must be filled", context);
                      }
                    ...
                    borderRadius: 10.r,
                    buttonColor:snapshot.hasData? AppColor.primary100:AppColor.black40,
                    height: 48.h,
                  );
                }
              )
