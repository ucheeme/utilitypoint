...
class Verifyforgotpasswordotp extends StatefulWidget {
  const Verifyforgotpasswordotp({super.key});

  @override
  State<Verifyforgotpasswordotp> createState() =>
      _VerifyforgotpasswordotpState();
}

class _VerifyforgotpasswordotpState extends State<Verifyforgotpasswordotp>
      ...
      builder: (context, state) {
        ...
        if (state is OnBoardingError) {
          WidgetsBinding.instance.addPostFrameCallback((_) {
            if (state.errorResponse.message ==
                "Sorry you entered the wrong code") {
              setState(() {
                isWrongOTP = true;
              });
            } else {
  ...
  _resendVerificationCodeEmail() {
    bloc.add(ResendEmailVerificationCodeEvent(
        bloc.validation.resendVerifiedEmailRequest()));
  }
}
