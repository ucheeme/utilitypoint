...
class NotificationsDesign extends StatefulWidget {
  NotificationList notificationList;
  bool changeColor;
  NotificationsDesign({super.key,required this.notificationList, required this.changeColor});
  @override
  State<NotificationsDesign> createState() => _NotificationsDesignState();
}

class _NotificationsDesignState extends State<NotificationsDesign> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child:Column(
          ...
          children: [
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(widget.notificationList.title,
                          style: CustomTextStyle.kTxtBold.copyWith(
                              color: AppColor.black100,
                              fontSize: 14.sp,
                              fontWeight: FontWeight.w400
                          ),),
                        Text(dateTimeFormatter(widget.notificationList.createdAt.toIso8601String()),
                          style: CustomTextStyle.kTxtMedium.copyWith(
                              fontWeight: FontWeight.w400,
                              fontSize: 12.sp,
                              color: AppColor.black80
            ...
            SizedBox(
              height: 36.w,
              child: Text(
                widget.notificationList.content,
                style:CustomTextStyle.kTxtMedium.copyWith(
  ...
  Color colorChoice(){
    ...
    if(widget.notificationList.readStatus==0) {
      setState(() {});
      return AppColor.primary30;
    }
    else if(widget.notificationList.readStatus!=0){
      setState(() {});
      return AppColor.black0;
    }
    else if(widget.changeColor){
      setState(() {

      });
      return AppColor.black0;
    }
    else{return AppColor.black0;}
  }
