...
import 'package:utilitypoint/view/menuOption/settingOptions/supportHelp/contactSupport.dart';
import 'package:utilitypoint/view/menuOption/settingOptions/supportHelp/faqScreen.dart';
import 'package:utilitypoint/view/menuOption/settingOptions/supportHelp/reportAnIssue.dart';
...
class _SupportAndHelpScreenState extends State<SupportAndHelpScreen>  with TickerProviderStateMixin {
        ...
        children: [
          SlideTransition(
            ...
            child: Padding(
              ...
              child: SizedBox(
                  height: 52.h,
                  child: CustomAppBar(title: "Support & Help")),
            ),
          ),
          Gap(20.h),
          SlideTransition(
  ...
  navigateToNewScreen(int position){
    switch(position){
      ...
      case 1: return Get.to(ContactsupportScreen());
      case 2: return Get.to(ReportanissueScreen());
    }
  }
