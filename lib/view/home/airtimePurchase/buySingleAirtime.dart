...
class SingleBuyAirtime extends StatefulWidget {
  const SingleBuyAirtime({super.key});

  @override
  State<SingleBuyAirtime> createState() => _SingleBuyAirtimeState();
}

class _SingleBuyAirtimeState extends State<SingleBuyAirtime>  with TickerProviderStateMixin {
        ...
        children: [
          SlideTransition(
            ...
            child: Padding(
              ...
              child: SizedBox(
                  height: 52.h,
                  child: CustomAppBar(title: "Buy airtime")),
            ),
          ),
          Gap(20.h),
          SlideTransition(
