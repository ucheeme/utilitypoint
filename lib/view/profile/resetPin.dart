...
import 'package:utilitypoint/view/profile/newTransactionPin.dart';
...
class _ResetTransactionPinState extends State<ResetTransactionPin>with TickerProviderStateMixin {
        ...
        children: [
          SlideTransition(
            ...
            child: Padding(
              ...
              child: SizedBox(
                  height: 52.h,
                  child: CustomAppBar(title:"Current transaction Pin")),
            ),
          ),
          Gap(20.h),
          SlideTransition(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    height55,
                    CustomButton(onTap: () {
                      print(userDetails!.pin);
                      if(pinValue.contains(userDetails!.pin)){
                        Get.to(NewTransactionPin(oldPin: pinValue));
                      }else{
                        AppUtils.showInfoSnackFromBottom("Incorrect Pin", context);
                      }
