...
import 'package:utilitypoint/view/profile/confirmTransactionPin.dart';
...
class NewTransactionPin extends StatefulWidget {
  String oldPin;
   NewTransactionPin({super.key, required this.oldPin});

  @override
  State<NewTransactionPin> createState() => _NewTransactionPinState();
}

class _NewTransactionPinState extends State<NewTransactionPin>with TickerProviderStateMixin {
        ...
        children: [
          SlideTransition(
            ...
            child: Padding(
              ...
              child: SizedBox(
                  height: 52.h,
                  child: CustomAppBar(title:"Enter New Transaction Pin")),
            ),
          ),
          Gap(20.h),
          SlideTransition(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    height55,
                    CustomButton(onTap: () {
                      Get.to(ConfirmTransactionPin(oldPin: widget.oldPin, newPin:pinValue),
                      curve: Curves.easeIn
                      );
                      ...
                      buttonColor: (pinValue.isNotEmpty && pinValue.length==4)?AppColor.primary100:AppColor.primary40,),
                  ],
                ),
              ),
            ),
